...
resource "google_compute_instance" "app" {
  ...
  metadata {
    ...
    #ssh-keys = "appuser:${file("~/.ssh/username.pub")}"
...
# добавление 2го инстанса через дублирование ресурса, 
# вместо использования параметра count в параметрах инстанса
